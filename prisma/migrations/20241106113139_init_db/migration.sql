...
-- CreateEnum
CREATE TYPE "TranscationPaymentMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'BANK_TRANSFER', 'BANK_SLIP', 'CASH', 'PIX', 'OTHER');
...
CREATE TABLE "Transaction" (
    ...
    "paymentMethod" "TranscationPaymentMethod" NOT NULL,
